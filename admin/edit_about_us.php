...
?>
        ...
        <div class="panel-body">
          ...
          <form method="post" class="form-horizontal">
            ...
            <div class="form-group">
              ...
              <select name="payment_status" class="select form-control">
                      ...
                      <option value="refunded" <?php if($payment_status == "refunded") {echo 'selected';} ?>>Refunded</option>
              </select>
            ...
            <div class="form-group">
              ...
              <select name="order_status" class="select form-control">
  ...
  if (isset($_POST['submit'])) {
    ...
    if ($run_enquiry) {
      ...
      $_SESSION['order_updated'] = 'success';
      session_write_close();
